...
const mockProjects: Project[] = [
  {
    ...
    description:
      "A platform redesign for Capitol Hill Arts Workshop focused on class discovery, enrollment clarity, and internal admin workflows.",
    image: CHAWCover,
    year: "2025",
    link: "#/projects/chaw",
  },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-[clamp(1.25rem,3vw,2rem)]">
            ...
            <p className="text-coco-text/65 mt-2 text-[clamp(0.95rem,1.3vw,1.05rem)]">
              Have a project or just want to say hi? I&apos;d love to hear from
              you.
            </p>
          </div>
